...
price_list = [32100, 32150, 32000, 32500]
for i in range(4):
    print(i, price_list[i])  # 내 풀이

price_list = [32100, 32150, 32000, 32500]
for i, data in enumerate(price_list):  # 정답풀이
    print(i, data)
...
price_list = [32100, 32150, 32000, 32500]
for i in range(4):
    print(3-i, price_list[i])   # 내 풀이

for i in range(len(price_list)):
    print((len(price_list) - 1) - i, price_list[i])  # 정답 풀이 len 사용하기
...
print(my_list[2], my_list[3])   # 내 풀이

for i in range(1, len(my_list)):
    print(my_list[i-1], my_list[i])   # 정답 풀이
